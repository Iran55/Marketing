...
CREATE TABLE `usuario` (
  ...
  `telefone` varchar(13) COLLATE utf8mb4_bin NOT NULL,
  `dataNasc` datetime NOT NULL,
  `dataCriacao` DATE NOT NULL, --datetime
...
CREATE TABLE `material` (
  ...
  `nomeMat` varchar(100) COLLATE utf8mb4_bin NOT NULL,
  `descrMat` varchar(200) COLLATE utf8mb4_bin NOT NULL,
  `statusMat` varchar(100) COLLATE utf8mb4_bin NOT NULL,
  `imagemMat` varchar(200) COLLATE utf8mb4_bin NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
